                ...
                <form class="form-horizontal" action="{{ route('admin.discount.update' , $discount->id) }}" method="POST">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="percent" class="form-control" placeholder="درصد تخفیف را وارد کنید" value="{{ old('percent' , $discount->person) }}">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="products[]" id="products" multiple>
                                ...
                                @foreach(\App\Models\Product::all() as $product)
                                    <option value="{{ $product->id }}" {{ in_array($user->id , $discount->users->pluck('id')->toArray() ) ? 'selected' : ''}}>{{ $product->title }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="form-group">
