...
{{--        //////////////// ckeditor-5 //////////////////////////////--}}
{{--        <script src="/js/ckeditor-5/ckeditor.js"></script>--}}

        <script>
            /////////////////// ckeditor-4 //////////////////////
            // CKEDITOR.replace('description', { filebrowserImageBrowserUrl: '/file-manager/ckeditor'});
            ...
            <div class="card">
                ...
                <form class="form-horizontal" method="POST" action="{{ route('admin.products.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        ...
                        <button class="btn btn-sm btn-danger" type="button" id="add_product_attribute"
                                onclick="createNewAttr()">ویژگی جدید
                        </button>
                    </div>
                    <!-- /.card-body -->
