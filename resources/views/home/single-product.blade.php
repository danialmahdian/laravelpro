                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        ...
                        @if (\App\Helpers\Cart\Cart::count($product) < $product->inventory)
                            ...
                            <span onclick="document.getElementById('add-to-cart').submit()"
                                  class="btn btn-sm btn-danger">اضافه کردن به سبد خرید</span>
                        @endif
                    </div>
                ...
                <div class="d-flex align-items-center justify-content-between">
                    ...
                    @auth()
                        <span class="btn btn-sm btn-primary" data-toggle="modal"
                              data-target="#sendComment" data-id="0">ثبت نظر جدید</span>
                    @endauth
                </div>
